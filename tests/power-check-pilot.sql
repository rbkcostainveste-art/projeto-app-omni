begin;
do $test$
declare co uuid; m uuid; pilot uuid; emp text; pe text; b text; w text; f jsonb; caught boolean;
begin
 ...
 w:=public.create_scoped_activity(gen_random_uuid()::text,b,'prefix','PR-QPC','',null,'Power Check','','','{}','routine','{}','[]');
