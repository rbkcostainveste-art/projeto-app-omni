...
const rows:CockpitEntry[]=[{id:'qualification:pilot:test',kind:'qualification',subject:'pilot',flight_id:null,data:{title:'CMA de teste',expires:'2027-01-31'},revision:1,created_by:'pilot',updated_by:'pilot',updated_at:'2026-09-10T03:00:00Z'}];
