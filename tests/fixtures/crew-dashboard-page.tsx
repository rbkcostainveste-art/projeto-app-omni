...
export default function Fixture(){
 ...
 return <main className="p-5"><CrewDashboard supabase={null} user="P1" base="QA" aircraft={[]} fleets={['AW139','S92']} flights={flights} requireSignature={async()=>true} onOpenTrail={f=>setOpened(f.id)} onError={noop}/><output>{opened}</output></main>;
}
