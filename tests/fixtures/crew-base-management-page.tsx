...
export default function AssignmentFixture(){
 ...
 const client=useMemo(()=>{
  const people=[{employee_number:'QA-P',display_name:'Piloto QA',access_profile:'commander',assigned_base:'Jacarepaguá',fleets:['S92','AW139'],mission:'mission_1',work_shift:'day',avatar_data_url:''},{employee_number:'QA-CP',display_name:'Copiloto QA',access_profile:'copilot',assigned_base:'Jacarepaguá',fleets:['S92'],mission:'mission_1',work_shift:'day',avatar_data_url:''},{employee_number:'QA-FA',display_name:'Comissário QA',access_profile:'flight_attendant',assigned_base:'Jacarepaguá',fleets:['S92'],mission:'mission_1',work_shift:'day',avatar_data_url:''},{employee_number:'QA-C',display_name:'Coordenação QA',access_profile:'coordination',assigned_base:'Jacarepaguá',fleets:['S92'],mission:'mission_1',work_shift:'day',avatar_data_url:''},{employee_number:'QA-M',display_name:'Mecânico QA',access_profile:'mechanic',assigned_base:'Jacarepaguá',fleets:['S92'],mission:'mission_1',work_shift:'day',avatar_data_url:''}];
