...
export type AssistantAgentResult={reply:string;proposedFlights:ReturnType<typeof parseFlightProposals>;sources:unknown[];trace:{tool:string;dataset?:string;status:string}[];navigation:{kind:AssistantRecordCard['kind'];id:string}|null;draftPatch?:{id:string;values:Record<string,string>}};
