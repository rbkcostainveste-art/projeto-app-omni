 ...
 for(let step=0;step<7;step++){
  ...
  if(!calls.length){
   ...
   if(answer.openTarget&&navigationEnabled){
    ...
    const datasets={maintenance:'maintenance',drying:'drying',wall:'timeline',activity:'assignments',flight:'flights',passage:'passage',tool:'tools',cockpit:'cockpit'} as const;
