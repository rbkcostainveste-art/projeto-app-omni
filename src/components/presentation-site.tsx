...
import { ArrowRight, CirclePlay, LockKeyhole, MessageCircle, Plane, X } from "lucide-react";
...
export function PresentationSite({ availableVideos = [] }: { availableVideos?: string[] }) {
  ...
  return <main className="presentation-site">
    ...
    <section className="presentation-contact"><div><p className="eyebrow">PRÓXIMO PASSO</p><h2>Vamos avaliar essa possibilidade juntos?</h2><p>Uma conversa com a direção e a TI para definir os requisitos e o caminho para uma validação controlada.</p></div><a href="https://wa.me/5521986739747" target="_blank" rel="noopener noreferrer"><MessageCircle size={20}/> Fale com Robson<small>(21) 98673-9747 · WhatsApp</small></a></section>
