...
export function PresentationSite({ availableVideos = [] }: { availableVideos?: string[] }) {
  ...
  return <main className="presentation-site">
    ...
    <button type="button" className="presentation-assistant-invite" onClick={() => openPresentationAssistant()}><Sparkles size={24} aria-hidden="true"/><span><strong>Converse com a IA sobre o aplicativo</strong><small>Pergunte, receba a resposta na hora e aprofunde os detalhes.</small></span><span className="presentation-assistant-invite-action">Começar conversa <ArrowRight size={17} aria-hidden="true"/></span></button>
    ...
    <section id="contato" className="presentation-contact"><div><p className="eyebrow">PROJETO INDEPENDENTE</p><h2>Quer saber mais sobre o projeto?</h2><p>Fale com Robson, criador do aplicativo, para tirar dúvidas e conhecer melhor a proposta.</p></div><div className="presentation-contact-card"><h3>Fale conosco</h3><p>Robson · Criador do projeto</p><p>(21) 98673-9747</p><div className="presentation-contact-options"><a href="tel:+5521986739747" aria-label="Ligar para (21) 98673-9747"><Phone size={20} aria-hidden="true"/><span>Ligar</span></a><a className="contact-whatsapp" href="https://wa.me/5521986739747" target="_blank" rel="noopener noreferrer" aria-label="Conversar pelo WhatsApp"><MessageCircle size={21} aria-hidden="true"/><span>WhatsApp</span></a></div></div></section>
