...
import type {AssistantTransfer} from '@/lib/assistant-handoff';
...
export function AssistantWorkspaceProvider({children}:{children:ReactNode}){
 ...
 return <Context.Provider value={{register,open,close,screen,setScreen,transfer,beginTransfer,claimTransfer}}>{children}{host&&root?createPortal(<>
