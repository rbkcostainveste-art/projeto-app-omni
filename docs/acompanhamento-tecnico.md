...
- **Gerar ação** fica no topo do relato e também está disponível ao mecânico da base. Cria atividade pendente vinculada, sem registrar execução ou APRS. Mantém-se a restrição de base do servidor.
